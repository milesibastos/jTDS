...
public class ConnectionJDBC2UnitTest extends UnitTestBase {
     ...
     * {@link JtdsConnection#unpackProperties(Properties)} is called
    ...
    private void assertSQLExceptionForBadWholeNumberProperty(final String key) {
        ...
        final JtdsConnection instance =
                (JtdsConnection) invokeConstructor(
                        JtdsConnection.class, new Class[]{}, new Object[]{});
    ...
    /**
     * Class used to test <code>net.sourceforge.jtds.jdbc.JtdsConnection.unpackProperties(Properties)</code>.
     */
